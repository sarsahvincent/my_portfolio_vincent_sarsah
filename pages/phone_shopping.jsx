...
import Shine from '../public/assets/projects/phone_signUp.jpg';
    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Phone Shopping App</h2>
          <h3>React Native</h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <p>
            This is a React Native application where users can register, access
            their profile and do basic update of their profile.
          </p>

          <a
            href='https://github.com/sarsahvincent/react_native_expo_e_commerce'
            target='_blank'
            rel='noreferrer'
          >
